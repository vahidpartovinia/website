...
function simulationTick() {
	...
	if (tick >= temps) {
		...
		document.getElementById("etat_file").innerHTML = "Terminé";
...
function verifierFile() {
	...
	{
		document.getElementById("etat_file").innerHTML = "En Cours";
		document.getElementById("etat_file").style.backgroundColor = "#008000";
	}
	else
	{
		document.getElementById("etat_file").innerHTML = "Débordement";
...
function reinitialiser() {
	...
	document.getElementById("start_btn").disabled = false;
	document.getElementById("etat_file").innerHTML = "Prêt";
	document.getElementById("etat_file").style.backgroundColor = "#008000";
...
function verifierVariables() {
	...
	if (intervalle < 50)
		document.getElementById("warning").textContent = "La simulation sera ralentie par le nombre excessif d'iterations";
	else
